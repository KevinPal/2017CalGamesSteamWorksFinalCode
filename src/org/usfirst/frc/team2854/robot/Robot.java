...
import org.usfirst.frc.team2854.commandGroups.BallDumpAutoBlue;
import org.usfirst.frc.team2854.commandGroups.BallDumpAutoRed;
import org.usfirst.frc.team2854.commandGroups.CenterAuto;
import org.usfirst.frc.team2854.commandGroups.CloseRaise;
import org.usfirst.frc.team2854.commandGroups.OpenLower;
import org.usfirst.frc.team2854.commandGroups.PickUpGear;
import org.usfirst.frc.team2854.commandGroups.SideBaseLineAutoBlue;
import org.usfirst.frc.team2854.commandGroups.SideBaseLineAutoRed;
...
import org.usfirst.frc.team2854.robot.commands.initGearVision;
import org.usfirst.frc.team2854.robot.commands.doors.CloseBotDoor;
import org.usfirst.frc.team2854.robot.commands.doors.CloseTopDoor;
import org.usfirst.frc.team2854.robot.commands.doors.OpenBotDoor;
import org.usfirst.frc.team2854.robot.commands.doors.OpenTopDoor;
...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		chooser.addObject("Ball Dump Boiler Right", new BallDumpAutoBlue());
		chooser.addObject("Ball Dump Auto Boiler Left", new BallDumpAutoRed());
		chooser.addObject("Base Line Auto Red", new SideBaseLineAutoRed());
		chooser.addObject("Base Line Auto Blue", new SideBaseLineAutoBlue());
...
//		}
	...
	public void teleopPeriodic() {
		...
		OI.openBallDoorTop.whenPressed(new OpenTopDoor());
		OI.openBallDoorTop.whenReleased(new CloseTopDoor());
		OI.pickUpGear.whenPressed(new PickUpGear(gearVision));
		//OI.gearInit.whenPressed(new initGearVision(gearVision));
		OI.raiseGear.whenPressed(new CloseRaise());
		OI.lowerGear.whenPressed(new OpenLower());
